...
namespace GymProject.Portal.Domain
{
    public class Data
    {
        public IEnumerable<Navbar> navbarItems()
        {
            ...
            menu.Add(new Navbar { Id = 18, nameOption = "Register Users", controller = "Register", action = "Index", imageClass = "fa fa-users fa-fw", status = true, isParent = false, parentId = 0 });
